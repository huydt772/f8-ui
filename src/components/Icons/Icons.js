...
export const SearchIcon = ({ className, width = '1.8rem', height = '1.8rem' }) => (
    <svg className={className} width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
        <g>
            <rect id="Canvas" width="36" height="36" fill="rgba(68,68,68,0)" />
        </g>
        <g transform="translate(1.103 0.969)">
            <path
